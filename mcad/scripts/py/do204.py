...
#
#   Description: this script generates a number of DO204 package diodes
#
...
diode.build("do204_0I200VA", 0.3937, False, True, 5.08, 4)
diode.build("do204_0I300VA", 0.3937, False, True, 7.62, 4)
