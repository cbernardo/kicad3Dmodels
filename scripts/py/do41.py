...
diode.build("do41_0I500H", 0.3937, True, False, 12.7)
diode.build("do41_0I600H", 0.3937, True, False, 15.24)
diode.build("do41_0I700H", 0.3937, True, False, 17.78)
diode.build("do41_0I800H", 0.3937, True, False, 20.32)
diode.build("do41_0I900H", 0.3937, True, False, 22.86)
diode.build("do41_1I000H", 0.3937, True, False, 25.4)

diode.setNVertices(16, 48, 10)

# vertical orientation, pin 1 is the cathode
diode.build("do41_0I100V", 0.3937, False, False, 2.54)
diode.build("do41_0I200V", 0.3937, False, False, 5.08)

# vertical orientation, pin 2 is the cathode
diode.build("do41_0I100VK2", 0.3937, False, True, 2.54)
diode.build("do41_0I200VK2", 0.3937, False, True, 5.08)
